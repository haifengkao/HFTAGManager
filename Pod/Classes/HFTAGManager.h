 ...
 */
@interface HFTAGManager : NSObject
 ...
 */
//- (HFTAGContainer *)getContainerById:(NSString *)containerId; // not implemented
 ...
 */
//@property(nonatomic, assign) NSTimeInterval dispatchInterval; // not implemented
